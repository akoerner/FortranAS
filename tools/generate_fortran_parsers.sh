...
FORTRAN_PARSER_INSTANCE_OF_TEMPLATE="${FORTRAN_AS_BASE_DIRECTORY}/FortranAS/src/FortranParserInstanceOf.java.template"
FORTRAN_PARSER_LOADER_TEMPLATE_PATH="${FORTRAN_AS_BASE_DIRECTORY}/FortranAS/src/Antlr4ParserLoader.java.template"
FORTRAN_PARSER_LOADER_TEMPLATE="${FORTRAN_AS_BASE_DIRECTORY}/FortranAS/src/Antlr4ParserLoader.java.template"
FORTRAN_PARSERS_SEARCH_PATH="${FORTRAN_AS_BASE_DIRECTORY}/antlr4/generated"
OUTPUT_DIRECTORY="${FORTRAN_AS_BASE_DIRECTORY}/FortranAS/src/generated"
